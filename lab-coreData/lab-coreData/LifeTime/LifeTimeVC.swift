...
class LifeTimeVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
...
extension LifeTimeVC {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let lifetime = fetchedResultsController?.fetchedObjects?[indexPath.row]
         ...
         cell.label2.text = "Status: \(lifetime?.shipInstructure ?? "")"
         cell.label3.text = "return flag:\(lifetime!.returnFlag)"
         cell.label4.text = "Ship Date:\(lifetime!.shipDate ?? Date())"
         cell.label5.text = "Recipt Date:\(lifetime!.receiptDate ?? Date())"
