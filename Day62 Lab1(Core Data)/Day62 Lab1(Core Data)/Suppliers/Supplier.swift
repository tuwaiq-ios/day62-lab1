...
class SupplierVc : UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = UIColor( #colorLiteral(red: 0, green: 0.4206840694, blue: 0.3233159482, alpha: 1))
...
class SupplierCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        contentView.backgroundColor =  UIColor( #colorLiteral(red: 0, green: 0.4206840694, blue: 0.3233159482, alpha: 1))
        ...
        NSLayoutConstraint.activate([
            ...
            websiteLable.rightAnchor.constraint(equalTo: self.rightAnchor, constant:5),
