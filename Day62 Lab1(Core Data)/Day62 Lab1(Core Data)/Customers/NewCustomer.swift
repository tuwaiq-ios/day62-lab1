...
class NewCustomer: UIViewController, UITextFieldDelegate {
    ...
    @objc func add() {
        let s = Customer( context: DataService.shared.viewContext)
    ...
    override func viewDidLoad() {
        ...
        LabelN.frame = CGRect(x: 290, y: 70, width: 110, height:130)
        LabelID.frame = CGRect(x: 260, y: 150, width: 140, height:130)
