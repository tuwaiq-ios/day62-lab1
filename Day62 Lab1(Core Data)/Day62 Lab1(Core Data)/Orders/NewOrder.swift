...
class NewOrder: UIViewController, UITextFieldDelegate {
        ...
        lazy var datePicker: UIDatePicker = {
            ...
            pic.addTarget(self, action: #selector(dateChanged), for: .valueChanged)
        ...
        @objc func add() {
            ...
            x.status = TF1.text ?? ""
            x.totalPrice = Double(TF2.text ?? "")!
            x.orderData =  datePicker.date
            x.shippingPriority = Int16(TF3.text ?? "")!
