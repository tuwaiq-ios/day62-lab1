...
extension LifeTime {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let lifetime = fetchedResultsController?.fetchedObjects?[indexPath.row]
         ...
         cell.label3.text = "return flag:\(lifetime!.returnFlaq)"
         cell.label4.text = "Ship Date:\(lifetime!.shipData ?? Date())"
         cell.label5.text = "Recipt Date:\(lifetime!.receiptData ?? Date())"
