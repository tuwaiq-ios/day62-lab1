...
class NewLifeTime: UIViewController, UITextFieldDelegate {
    ...
    @objc func add() {
        ...
        s.returnFlaq = Bool(TF2.text ?? "") ?? true
        s.shipData =  datePicker.date
        s.receiptData =  datePicker2.date
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            addButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -250),
